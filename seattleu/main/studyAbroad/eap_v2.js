...
writeHtml([
  ...
  '</div>',
  '</div>',
  '<blockquote class="subsection"><h3 class="subsection-title">Features</h3>',
  ...
  '<p class="subsection-text">A visa is a permission granted by a country that allows foreign nationals to enter and reside there temporarily. Applicants typically need to provide documentation such as an acceptance letter from the educational institution, proof of financial means, and health insurance. Student visas come with specific regulations regarding work rights, travel restrictions, and duration of stay, varying by country.</p>',
