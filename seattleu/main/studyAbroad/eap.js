...
String.prototype.wrap = function(tags) {
  ...
  return tags.map(val => {
    ...
    var templateHTMLMulti = '<div class="dropdownWrap"><button class="dropbtn" id="dropdownMenuButton">NAME</button><div class="dropdown-content">TARGET</div></div>'
    ...
    '<div class="hero--basic hero--program-detail bg--dark global-padding--15x with-photo ea-program-detail">',
        ...
        '<div class="grid-x grid-margin-x">',
          '<div class="cell auto">',
            '<div class="hero--basic__text text-margin-reset">',
              ...
              '<div class="global-spacing--3x"><div class="wysiwyg"></div></div>', 
      ...
      '</div>',
    '</div>',
    '<section class="program-info ea-program-detail global-margin--15x even">',
      '<div class="grid-container">',
        '<div class="grid-x grid-margin-x">',
          '<div class="cell medium-8">',
            '<h2>About this Program</h2>',
            '<div class="wysiwyg"><p class="text-danger">' + get('Program Summary HTML') + '</p></div><!-- /.wysiwyg -->',
